import { AiWorkbench, AppShell, CaptureWorkbench, CommentsWorkbench, exportTeamSnapshot, GraphqlWorkbench, GrpcWorkbench, HttpWorkbench, MockWorkbench, PluginCenter, RedisWorkbench, restoreTeamSnapshot, RpcWorkbench, SocketWorkbench, SseWorkbench, SsoWorkbench, TeamWorkbench, WebSocketWorkbench, WorkbenchDeck, WorkspaceExplorer, type HttpWorkbenchRequest, type RedisWorkbenchRequest, type RpcWorkbenchRequest, type WorkspaceTree } from "@apivoy/ui";
import {
  cancelViaAgent,
