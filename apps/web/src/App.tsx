import { AiWorkbench, AmqpWorkbench, AppShell, CaptureWorkbench, CommentsWorkbench, exportTeamSnapshot, GraphqlWorkbench, GrpcWorkbench, HttpWorkbench, KafkaWorkbench, MockWorkbench, MqttWorkbench, PluginCenter, RedisWorkbench, restoreTeamSnapshot, RpcWorkbench, SocketWorkbench, SseWorkbench, SsoWorkbench, TeamWorkbench, WebSocketWorkbench, WorkbenchDeck, WorkspaceExplorer, type AmqpWorkbenchRequest, type HttpWorkbenchRequest, type KafkaWorkbenchRequest, type MqttWorkbenchRequest, type RedisWorkbenchRequest, type RpcWorkbenchRequest, type WorkspaceTree } from "@apivoy/ui";
import {
  cancelViaAgent,
