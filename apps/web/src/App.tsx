import { AppShell, exportTeamSnapshot, GraphqlWorkbench, GrpcWorkbench, HttpWorkbench, MockWorkbench, PluginCenter, restoreTeamSnapshot, SocketWorkbench, SseWorkbench, TeamWorkbench, WebSocketWorkbench, WorkbenchDeck, WorkspaceExplorer, type HttpWorkbenchRequest, type WorkspaceTree } from "@apivoy/ui";
import {
  cancelViaAgent,
