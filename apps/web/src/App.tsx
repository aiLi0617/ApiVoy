import { AppShell, GraphqlWorkbench, GrpcWorkbench, HttpWorkbench, MockWorkbench, PluginCenter, SocketWorkbench, SseWorkbench, WebSocketWorkbench, WorkbenchDeck, WorkspaceExplorer, type HttpWorkbenchRequest, type WorkspaceTree } from "@apivoy/ui";
import {
  cancelViaAgent,
...
export function App() {
  ...
  return (
    <AppShell channelLabel="Web → Local Agent" explorer={<WorkspaceExplorer tree={tree} selectedCollectionId={selectedCollectionId} selectedRequestId={selectedRequestId}
      ...
      <WorkbenchDeck tabs={[{ id: "http", label: "HTTP", protocol: "http" }, { id: "sse", label: "SSE", protocol: "sse" }, { id: "socket", label: "TCP / UDP", protocols: ["tcp", "udp"] }, { id: "graphql", label: "GraphQL", protocol: "graphql" }, { id: "websocket", label: "WebSocket", protocol: "websocket" }, { id: "grpc", label: "gRPC", protocol: "grpc" }, { id: "mock", label: "Mock" }, { id: "plugins", label: "Plugins" }]}>
      <HttpWorkbench
