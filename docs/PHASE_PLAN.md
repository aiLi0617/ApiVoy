...
> P1 协议扩展已完成 SOAP 1.1/1.2、JSON-RPC 2.0 与 Redis RESP2/RESP3 的 Driver、Agent/Desktop/CLI 注册和 Web/Desktop 工作台；MQTT/AMQP/Kafka/SQL 仍待实现。
...
| 协议扩展 | 🟡 SOAP 1.1/1.2、JSON-RPC 2.0、Redis RESP2/RESP3 已完成；MQTT、AMQP、Kafka、SQL 待实现 | Driver SPI 稳定；Redis 覆盖 ACL/Secret 引用、数据库选择、流水线、二进制响应、超时与取消 |
