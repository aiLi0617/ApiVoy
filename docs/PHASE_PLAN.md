...
> P1 协议扩展已完成 SOAP、JSON-RPC、Redis、AMQP、Kafka 与 PostgreSQL/MySQL/SQLite；MQTT 3.1.1 发布/订阅已落地，剩余 MQTTS/QoS 2 增强继续实施。
...
| 协议扩展 | 🟡 SOAP、JSON-RPC、Redis、AMQP、Kafka、SQL 已完成；MQTT 发布/订阅已完成，MQTTS/QoS 2 待实现 | SQL 覆盖 PostgreSQL/MySQL/SQLite、参数绑定、事务、动态类型/二进制结果、行数上限、Secret 与 TLS 连接串 |
