...
> P1 协议扩展已完成 SOAP 1.1/1.2、JSON-RPC 2.0、Redis RESP2/RESP3；MQTT 3.1.1 的发布/订阅、QoS 0/1、认证与双端工作台已落地，MQTTS/QoS 2 及 AMQP/Kafka/SQL 继续实施。
...
| 协议扩展 | 🟡 SOAP、JSON-RPC、Redis 已完成；MQTT 3.1.1 发布/订阅与 QoS 0/1 已完成，MQTTS/QoS 2、AMQP、Kafka、SQL 待实现 | Driver SPI 稳定；MQTT 覆盖 Secret 认证、Clean Session、Retain、消息限额、超时与取消 |
