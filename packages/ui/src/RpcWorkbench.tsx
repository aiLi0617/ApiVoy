...
const styles: Record<string, CSSProperties> = {
  root: { border: "1px solid var(--apivoy-border)", borderRadius: 18, background: "radial-gradient(760px 340px at 100% -10%,rgba(36,197,183,.12),transparent 60%),linear-gradient(150deg,rgba(18,27,38,.97),rgba(8,13,20,.99))", padding: 22 },
  ...
  send: { border: 0, borderRadius: 8, background: "linear-gradient(135deg,#1eb6a9,#308ec8)", color: "white", fontWeight: 750, padding: "10px 16px", cursor: "pointer" }, stop: { border: "1px solid rgba(240,113,120,.4)", borderRadius: 8, background: "rgba(240,113,120,.1)", color: "#ffbdc0", padding: "9px" },
