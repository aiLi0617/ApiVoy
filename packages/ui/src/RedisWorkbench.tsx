...
const styles: Record<string, CSSProperties> = {
  root: { padding: 22, border: "1px solid var(--apivoy-border)", borderRadius: 18, background: "radial-gradient(700px 320px at 0 -10%,rgba(226,69,64,.13),transparent 62%),linear-gradient(145deg,#111820,#070c12)" },
  ...
  targetRow: { display: "grid", gridTemplateColumns: "170px 1fr auto auto", gap: 8, marginBottom: 12 }, name: { border: "1px solid var(--apivoy-border)", borderRadius: 8, padding: 10, background: "#080d13", color: "var(--apivoy-text)" }, target: { border: "1px solid var(--apivoy-border)", borderRadius: 8, padding: 10, background: "#080d13", color: "#ffd0ce", fontFamily: "var(--apivoy-mono)" }, send: { border: 0, borderRadius: 8, padding: "10px 16px", background: "linear-gradient(135deg,#db443f,#aa2f47)", color: "white", fontWeight: 800, cursor: "pointer" }, cancel: { border: "1px solid #744", borderRadius: 8, background: "#281416", color: "#ffc4c1" },
