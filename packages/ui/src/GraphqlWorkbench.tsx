...
const styles: Record<string, CSSProperties> = {
  root: { marginTop: 22, padding: 20, border: "1px solid var(--apivoy-border)", borderRadius: 16, background: "radial-gradient(circle at 100% 0,rgba(232,107,185,.10),transparent 32%),linear-gradient(145deg,#12101b,#0b1119)", boxShadow: "0 18px 48px rgba(0,0,0,.18)" },
  ...
  row: { display: "flex", gap: 8, flexWrap: "wrap" }, url: { flex: "1 1 320px", minWidth: 0, background: "#090d14", color: "var(--apivoy-text)", border: "1px solid var(--apivoy-border)", borderRadius: 9, padding: 11 }, operation: { width: 200, background: "#090d14", color: "var(--apivoy-text)", border: "1px solid var(--apivoy-border)", borderRadius: 9, padding: 11 }, run: { border: 0, borderRadius: 9, background: "linear-gradient(135deg,#f083c9,#d858aa)", color: "#210817", fontWeight: 800, padding: "0 20px" }, secondary: { border: "1px solid #683a5a", borderRadius: 9, padding: "0 13px", background: "#211426", color: "#ef9bd2" }, cancel: { border: "1px solid #71434a", borderRadius: 9, background: "#2b171b", color: "#ff9ca8" },
